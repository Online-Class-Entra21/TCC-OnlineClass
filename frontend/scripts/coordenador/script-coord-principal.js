...
if(idUsuario != 0 && idUsuario != null){
        ...
        $( ".colunaRen" ).click(function() { 
            ...
            xhr.addEventListener("load", function(){
                ...
                if(dataAtual < (dataReuniao.setMinutes(dataReuniao.getMinutes() - 10))){
                    ...
                    location.href = "/frontend/paginas/coordenador/coord-videochamada.html"
                }
            })
            xhr.send();
        });
    ...
    async function mostrarRelatorios(relatorios){
        ...
        $( ".colunaRel" ).click(function() { 
            ...
            novaJanela = window.open ("/frontend/paginas/coordenador/coord-relatorio-aberto.html", "popup", "width="+screen.width/3+", height="+screen.height/1.5+", left="+(screen.width-(screen.width/3))/2+", top="+(screen.height-(screen.height/1.5))/2);
        });
    }
...
document.getElementById("criarRelatorios").addEventListener("click", function(){
    location = "/frontend/paginas/coordenador/coord-relatorios.html";
})
document.getElementById("criarReunioes").addEventListener("click", function(){
    location = "/frontend/paginas/coordenador/coord-reunioes.html";
})